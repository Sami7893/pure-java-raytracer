...
import carlvbn.raytracing.rendering.ThreadPool;
...
public class Renderer {
    ...
    public static ThreadPool tPool;
     ...
     */
    public static void renderSceneV(Scene scene, Graphics gfx, int width, int height, float resolution) {
